...
class ElectionTypeApi{
  ...
  static Future<List<ElectionType>> getElections(String? schoolId) async {
     String baseUrl =
      '${host}elections?school=$schoolId';

    try {
      final response = await http.get(
        Uri.parse(baseUrl),
        headers: {'Content-Type': 'application/json'}, // Assuming you are requesting JSON data
      );
